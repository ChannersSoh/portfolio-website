...
const AboutMe: React.FC = () => {
    ...
    return (
      <main className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg mt-8 text-center">
        ...
        <p  className="text-gray-800 mb-6">I hold a degree in Genetics and a postgraduate degree in Molecular Genetics. During my time as a research assistant, I frequently worked with computers, especially with analytical software, which sparked my interest in coding. Having previously worked with code and greatly enjoyed it, I decided to take a further step, leading me to join the NorthCoders bootcamp. This experience allowed me to solidify my skills and gain deeper insights into the field. </p>
